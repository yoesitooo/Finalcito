...
public class Reina extends Pieza{
	...
	//Constructor
	public Reina(final Equipo piezaEquipo, final int posicion) {
		super(TipoDePieza.REINA, posicion, piezaEquipo);
	}
	//Metodo para calcular los movimientos legales de la reina
	@Override
	...
	@Override
	public Reina muevePieza(final Movimiento movimiento) {
		return new Reina(movimiento.getPiezaMovida().getEquipo(), movimiento.getCoordDestino());
	}
	@Override
